...
<form class="form-horizontal" method="POST">
  <div class="control-group">
    <label class="control-label" for="inputTittle">Tittle</label>
    <div class="controls">
      <input type="text" id="inputTittle" name="tittle"></input>
    </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="ckfinder-input-popup-1" name="images" placeholder="url...">
